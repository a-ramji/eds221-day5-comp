...
# The line below establishes a storage matrix with the initial population conditions (roe, fry, juvenille, adult) as columns, with the time sequence of years as the number of rows. 
proj_year <- matrix(ncol = length(fish_year0), nrow = length(time_yr))

# The line below it's filling the empty matrix with the first row as the initial population conditions
